...
**Resposta:** Sim. Derivação: $S \Rightarrow b$.

### 2.

A palavra `ab` pode ser gerada?

**Resposta:** Sim. Derivação: $S \Rightarrow aS \Rightarrow ab$.

### 3.

A palavra `aab` pode ser gerada?

**Resposta:** Sim. Derivação: $S \Rightarrow aS \Rightarrow aaS \Rightarrow aab$.

### 4.

A palavra `aaab` pode ser gerada?

**Resposta:** Sim. Derivação: $S \Rightarrow aS \Rightarrow aaS \Rightarrow aaaS \Rightarrow aaab$.

### 5.

A palavra `aba` pode ser gerada?

**Resposta:** Não. A regra $S \rightarrow b$ encerra a derivação, não sendo possível gerar a letra `a` depois de `b`.
...
**Resposta:** O padrão das palavras geradas por essa gramática é: qualquer quantidade (zero ou mais) da letra `a` seguida obrigatoriamente por exatamente uma letra `b` no final. (Exemplo de formato: $a^nb$ onde $n \geq 0$).
